...
<script type="text/javascript">
    ...
    $(".dept_edit_btn").click(function () {
        ...
        console.log("id"+edit_deptId);
        //查询对应deptId的部门信息
        $.ajax({
            url:"${pageContext.request.contextPath}/ssm/dept/getDeptById/"+edit_deptId,
            type:"GET",
    ...
    $(".dept_update_btn").click(function () {
        $.ajax({
            url:"${pageContext.request.contextPath}/ssm/dept/updateDept/"+edit_deptId,
            type:"PUT",
