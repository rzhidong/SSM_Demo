...
<script type="text/javascript">
    ...
    $(".dept_save_btn").click(function () {
        ...
        //验证省略...
        $.ajax({
            url:"${pageContext.request.contextPath}/ssm/dept/addDept",
            type:"PUT",
            ...
            success:function (result) {
                if(result.code == 100){
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath}/ssm/dept/getTotalPages",
                        type:"GET",
                        success:function (result) {
                            if (result.code == 100){
                                var totalPage = result.extendInfo.totalPages;
                                window.location.href="${pageContext.request.contextPath}/ssm/dept/getDeptList?pageNo="+totalPage;
                            }
                        }
                    });
                }else {
