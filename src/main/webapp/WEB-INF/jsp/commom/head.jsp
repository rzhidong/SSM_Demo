    ...
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" id="company_logo" href="#">SSM公司LOGO</a>
            </div>
...
<script type="text/javascript">
    ...
    $("#company_logo").click(function () {
        $(this).attr("href", "${pageContext.request.contextPath}/ssm/main");
    });
    //账号退出
    $(".logout").click(function () {
        window.location.href = "${pageContext.request.contextPath}/ssm/logout";
    });
</script>
</body>
</html>
