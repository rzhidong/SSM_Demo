...
<body>
<div class="ssm_dept_container">
    <!-- 导航栏-->
    <%@ include file="./commom/head.jsp"%>


    <!-- 中间部分（左侧栏+表格内容） -->
    <div class="ssm_dept_body">
        <!-- 左侧栏 -->
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <nav aria-label="Page navigation" class="pull-right">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/ssm/dept/getDeptList?pageNo=1">首页</a></li>
                            ...
                            <c:forEach begin="1" end="${totalPages<7?totalPages:7}" step="1" var="itemPage">
                                <li <c:if test="${curPageNo == itemPage}">class="active"</c:if>>
                                     <a href="${pageContext.request.contextPath}/ssm/dept/getDeptList?pageNo=${itemPage}">${itemPage}</a>
                                </li>
                            </c:forEach>
                            ...
                            <li><a href="${pageContext.request.contextPath}/ssm/dept/getDeptList?pageNo=${totalPages}">尾页</a></li>
                        </ul>
                    </nav>
                </div>
...
<script type="text/javascript">
    ...
    $(".prePage").click(function () {
         if (curPageNo > 1){
             ...
             $(this).attr("href", "${pageContext.request.contextPath}/ssm/dept/getDeptList?pageNo="+pageNo);
         }
    });
    //下一页
    ...
    $(".dept_delete_btn").click(function () {
        ...
        if (confirm("确认删除【"+ delDeptName +"】的信息吗？")){
            $.ajax({
                url:"${pageContext.request.contextPath}/ssm/dept/delDept/"+delDeptId,
                type:"DELETE",
                success:function (result) {
                    if (result.code == 100){
                        alert("删除成功！");
                        window.location.href = "${pageContext.request.contextPath}/ssm/dept/getDeptList?pageNo="+curPageNo;
                    }else {
