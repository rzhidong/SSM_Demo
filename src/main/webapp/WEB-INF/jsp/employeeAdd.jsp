...
<script type="text/javascript">
    ...
    $(".emp_add_btn").click(function () {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/ssm/dept/getDeptName",
            type:"GET",
    ...
    $("#add_inputName").change(function () {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/ssm/emp/checkEmpExists",
            type:"GET",
    ...
    $(".emp_save_btn").click(function () {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/ssm/emp/addEmp",
            type:"POST",
            ...
            success:function (result) {
                if (result.code == 100){
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath}/ssm/emp/getTotalPages",
                        type:"GET",
                        success:function (result) {
                            var totalPage = result.extendInfo.totalPages;
                            window.location.href="${pageContext.request.contextPath}/ssm/emp/getEmpList?pageNo="+totalPage;
                        }
                    })
                } else {
                    alert("员工新增失败！");
